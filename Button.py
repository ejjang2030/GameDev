...
class Button(TextView):
    def __init__(self, surface, text, text_size, text_color, button_position, button_size, default_color, active_color, border_radius):
        ...
        self.setTextPosition((self.button_position[0] + self.button_size[0] // 2, self.button_position[1] + self.button_size[1] // 2))
    ...
    def onClickListener(self, action=None):
        ...
        if self.button_position[0] + self.button_size[0] > mouse_pos[0] > self.button_position[0] and \
            ...
            pygame.draw.rect(self._surface, self.active_color, (self.button_position, self.button_size), 0, self.border_radius)
            if mouse_clicked[0]:
                print("Button", self._text, "Clicked")
                if action is not None:
                    action()
        else:
            pygame.draw.rect(self._surface, self.default_color, (self.button_position, self.button_size), 0, self.border_radius)
        self.showText()
